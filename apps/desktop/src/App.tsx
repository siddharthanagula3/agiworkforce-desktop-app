...
import { MobileCompanionWorkspace } from './components/Mobile/MobileCompanionWorkspace';
    ...
    <div className={shellClass}>
      ...
      <main className="flex flex-1 overflow-hidden min-h-0">
        ...
        <div className="flex-1 overflow-auto min-w-0">
          ...
          {activeSection === 'mobile' && <MobileCompanionWorkspace />}
          ...
          {activeSection !== 'dashboard' &&
            ...
            activeSection !== 'api' && (
              <div className="flex h-full items-center justify-center text-sm text-muted-foreground">
                {activeSection.charAt(0).toUpperCase() + activeSection.slice(1)} workspace is coming
                soon.
              </div>
            )}
        </div>
