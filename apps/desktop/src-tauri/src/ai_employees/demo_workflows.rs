    ...
    DemoWorkflow {
        ...
        steps: vec![
            ...
            DemoStep {
                ...
                input: step2_input,
                expected_result: "Generated email: 'Dear John, We offer a 30-day money-back guarantee...'".to_string(),
            },
        ],
        sample_input: "Customer inquiry: 'What is your refund policy?'".to_string(),
        expected_output: "Draft email sent to agent for review with refund policy details".to_string(),
        duration_seconds: 15,
    }
}
...
pub fn email_responder_demo() -> DemoWorkflow {
    let mut step1_input = HashMap::new();
    step1_input.insert("email_content".to_string(), "What are your business hours?".to_string());
...
pub fn live_chat_bot_demo() -> DemoWorkflow {
    let mut step1_input = HashMap::new();
    step1_input.insert("message".to_string(), "My product won't turn on".to_string());

    let mut step2_input = HashMap::new();
    step2_input.insert("steps".to_string(), "troubleshooting_power_issues".to_string());
    ...
    DemoWorkflow {
        ...
        steps: vec![
            ...
            DemoStep {
                ...
                input: step2_input,
                expected_result: "Sent troubleshooting steps: 1. Check power cable... 2. Try different outlet...".to_string(),
            },
        ],
        sample_input: "Chat: 'My product won't turn on, help!'".to_string(),
        expected_output: "Provided troubleshooting steps; escalated to agent after 3 attempts".to_string(),
        duration_seconds: 20,
    }
}
...
pub fn ticket_triager_demo() -> DemoWorkflow {
    let mut step1_input = HashMap::new();
    step1_input.insert("ticket_content".to_string(), "Critical: Production database down!".to_string());
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Category: Infrastructure, Severity: P0 (Critical), Team: DevOps".to_string(),
            },
        ],
...
pub fn lead_qualifier_demo() -> DemoWorkflow {
    ...
    DemoWorkflow {
        ...
        sample_input: "Lead form: Name: John Doe, Company: Acme Corp, Interest: Enterprise plan".to_string(),
        expected_output: "Qualified lead added to CRM with 85/100 score, assigned to sales rep".to_string(),
        duration_seconds: 25,
    }
}
...
pub fn email_campaigner_demo() -> DemoWorkflow {
    ...
    DemoWorkflow {
        ...
        expected_output: "Campaign created with 3 variants, scheduled for optimal send time (Tue 10am)".to_string(),
        duration_seconds: 30,
    }
}
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Post: 'Excited to announce our new AI-powered feature...' (280 chars)".to_string(),
            },
        ],
        sample_input: "Task: Create LinkedIn post about new AI feature".to_string(),
        expected_output: "Post drafted and scheduled for Thu 2pm (optimal engagement time)".to_string(),
        duration_seconds: 15,
    }
}
...
pub fn content_writer_demo() -> DemoWorkflow {
    ...
    step1_input.insert("seo_keywords".to_string(), "AI automation, productivity, efficiency".to_string());
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Generated 1,200-word post: 'How AI Automation Boosts Productivity by 40%'".to_string(),
            },
        ],
        sample_input: "Brief: Write blog post about AI automation benefits (1200 words, SEO-optimized)".to_string(),
        expected_output: "Blog post generated with title, sections, and meta description".to_string(),
        duration_seconds: 45,
    }
}
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Extracted: Name, Address, Phone, Email (95% confidence)".to_string(),
            },
            DemoStep {
        ...
        expected_output: "Processed 50 forms, inserted 48 records, flagged 2 for review (low confidence)".to_string(),
        duration_seconds: 20,
    }
}
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Vendor: Acme Supplies, Amount: $1,245.00, Due: 2025-12-15".to_string(),
            },
        ],
        sample_input: "Invoice PDF from vendor".to_string(),
        expected_output: "Invoice validated against PO #54321, added to QuickBooks, approval requested".to_string(),
        duration_seconds: 12,
    }
}
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Found: Thu 2pm EST / 11am PST / 7pm GMT (all attendees available)".to_string(),
            },
        ],
        sample_input: "Schedule 1-hour meeting with 5 people across 3 time zones".to_string(),
        expected_output: "Meeting scheduled Thu 2pm EST, invites sent, calendar holds placed".to_string(),
        duration_seconds: 10,
    }
}
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Found: 2 style issues, 1 security concern (SQL injection risk), 3 suggestions".to_string(),
            },
        ],
        sample_input: "PR #123: Add user authentication endpoint (150 lines changed)".to_string(),
        expected_output: "Review posted with 6 comments: 2 blocking issues, 4 suggestions".to_string(),
        duration_seconds: 25,
    }
}
...
pub fn bug_triager_demo() -> DemoWorkflow {
    let mut step1_input = HashMap::new();
    step1_input.insert("issue_description".to_string(), "App crashes when uploading large files".to_string());
    step1_input.insert("stack_trace".to_string(), "OutOfMemoryError at FileUploader.java:45".to_string());
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Category: File Upload, Severity: High, Component: Storage, Assignee: @john".to_string(),
            },
        ],
        sample_input: "Bug report: App crashes on large file upload".to_string(),
        expected_output: "Categorized as High severity, assigned to Storage team, linked to similar issue #456".to_string(),
        duration_seconds: 8,
    }
}
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Generated docs for 5 endpoints: GET/POST /users, GET/PUT/DELETE /users/:id".to_string(),
            },
        ],
        sample_input: "Source file: api/users.ts with 5 REST endpoints".to_string(),
        expected_output: "API docs generated with endpoint descriptions, parameters, responses, examples".to_string(),
        duration_seconds: 35,
    }
}
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Ran 45 tests: 43 passed, 2 failed (auth timeout, DB connection)".to_string(),
            },
        ],
        sample_input: "Run integration tests on feature branch".to_string(),
        expected_output: "Test report: 43/45 passed (95%), 2 failures with suggested fixes, coverage: 87%".to_string(),
        duration_seconds: 40,
    }
}
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Blocked 2-hour focus time: Mon/Wed/Fri 9-11am, moved 3 meetings".to_string(),
            },
        ],
        sample_input: "Calendar with scattered meetings and no focus blocks".to_string(),
        expected_output: "Optimized: Added 6hrs/week focus time, consolidated meetings, added 15-min buffers".to_string(),
        duration_seconds: 12,
    }
}
...
pub fn research_assistant_demo() -> DemoWorkflow {
    let mut step1_input = HashMap::new();
    step1_input.insert("topic".to_string(), "AI automation market trends 2025".to_string());
    ...
    DemoWorkflow {
        ...
        steps: vec![
            DemoStep {
                ...
                input: step1_input,
                expected_result: "Researched 10 sources, extracted 5 key trends, compiled 2-page report".to_string(),
            },
        ],
        sample_input: "Research: AI automation market trends for 2025".to_string(),
        expected_output: "Report: 5 key trends identified, 15 sources cited, market size forecast included".to_string(),
        duration_seconds: 60,
    }
}
