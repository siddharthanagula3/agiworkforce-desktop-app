...
) -> std::result::Result<Vec<AIEmployee>, String> {
...
pub async fn ai_employees_get_by_id(
    employee_id: String,
    state: State<'_, AIEmployeeState>,
) -> std::result::Result<AIEmployee, String> {
...
pub async fn ai_employees_get_user_employees(
    user_id: String,
    state: State<'_, AIEmployeeState>,
) -> std::result::Result<Vec<UserEmployee>, String> {
    let marketplace = state.marketplace.lock().map_err(|e| e.to_string())?;
    marketplace
...
pub async fn ai_employees_assign_task(
    ...
    state: State<'_, AIEmployeeState>,
) -> std::result::Result<EmployeeTask, String> {
    let executor = state.executor.lock().map_err(|e| e.to_string())?;
    executor
...
pub async fn ai_employees_execute_task(
    task_id: String,
    state: State<'_, AIEmployeeState>,
) -> std::result::Result<TaskResult, String> {
    let executor = state.executor.lock().map_err(|e| e.to_string())?;
    executor
...
pub async fn ai_employees_list_tasks(
    user_employee_id: String,
    state: State<'_, AIEmployeeState>,
) -> std::result::Result<Vec<EmployeeTask>, String> {
    let executor = state.executor.lock().map_err(|e| e.to_string())?;
    executor
...
pub async fn ai_employees_run_demo(
    employee_id: String,
    state: State<'_, AIEmployeeState>,
) -> std::result::Result<DemoResult, String> {
    let executor = state.executor.lock().map_err(|e| e.to_string())?;
    executor
...
pub async fn ai_employees_get_stats(
    employee_id: String,
    state: State<'_, AIEmployeeState>,
) -> std::result::Result<EmployeeStats, String> {
    let marketplace = state.marketplace.lock().map_err(|e| e.to_string())?;
    marketplace
