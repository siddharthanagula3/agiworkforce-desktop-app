...
import type { CalendarAccount, CalendarSummary, CalendarEvent, EventDateTime } from '../../types/calendar';
          ...
          <section className="flex flex-col">
            {events.length === 0 ? (
              <div className="flex h-full flex-col items-center justify-center text-muted-foreground">
                ...
                <p className="mt-2 text-sm">No events scheduled in this window.</p>
              </div>
            ) : (
              <ScrollArea className="h-full">
